      ...
      <div className="shop">
        <div>
          ...
          <div className="radios">
            ...
            <label>
              <input type="radio" name="category" /> View All
            </label>
            <br />

            <label>
              <input type="radio" name="category" /> Testings
            </label>
            <br />

            <label>
              <input type="radio" name="category" /> Hf
            </label>
            <br />

            <label>
              <input type="radio" name="category" /> Grocery & Staples
            </label>
            <br />

            <label>
              <input type="radio" name="category" /> Organic Food
            </label>
            <br />

            <label>
              <input type="radio" name="category" /> Biscuits & Snacks
            </label>
            <br />

            <label>
              <input type="radio" name="category" /> Fresh Fruits
            </label>
            <br />

            <label>
              <input type="radio" name="category" /> Fruit & Vegetables
            </label>
          </div>
